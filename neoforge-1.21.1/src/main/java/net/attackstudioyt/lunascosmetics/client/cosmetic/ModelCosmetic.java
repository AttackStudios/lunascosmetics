...
public class ModelCosmetic extends Cosmetic {
    ...
    public ModelCosmetic(String id, String name, String description, Slot slot, int accent,
        ...
        this.texture = ResourceLocation.fromNamespaceAndPath(LunasCosmetics.MOD_ID, "textures/cosmetic/" + texturePath + ".png");
        this.glowTexture = glow ? ResourceLocation.fromNamespaceAndPath(LunasCosmetics.MOD_ID, "textures/cosmetic/" + texturePath + "_glow.png") : null;
        this.motion = motion;
    ...
    public void render(RenderCtx ctx) {
        ...
        switch (motion) {
            ...
            case HALO -> {
                ...
                pose.move("halo", 0, Mth.sin(t * 2.1f) * 0.7f, 0);
                for (int i = 0; i < 3; i++) {
                    float s = 1 + 0.25f * Mth.sin(t * 3.2f + i * 2.1f);
            ...
            case WINGS -> {
                ...
                float a = Mth.sin(t * speed) * (8 + beat * 22);
        ...
        if (glowTexture != null) {
            int v = (int) (200 + 55 * Mth.sin(t * 2.7f));
